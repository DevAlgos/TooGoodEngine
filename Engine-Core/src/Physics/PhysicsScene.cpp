...
//	}
//
//	void PhysicsScene::DestroyObject(Ecs::EntityID GameObject)
//	{
...
//
//		for (Ecs::EntityID Entity = 0; Entity < LastEntity; Entity++)
//		{	
...
//		{
//			Ecs::EntityID Current = cell.EntitiesInCell[i];
//			
...
//			{
//				Ecs::EntityID Other = other.EntitiesInCell[j];
//
//				if (Current != Other)
//				{
...
//
//		for (Ecs::EntityID Current = 0; Current < LastEntity; Current++)
//		{
