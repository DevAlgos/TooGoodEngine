...
namespace TGE
{
	...
	{
		std::map<GLenum, const char*> ShaderList = {
			{GL_VERTEX_SHADER, "../Resources/shaders/Defaults/RayTracing/basicVertex.glsl"},
			{GL_FRAGMENT_SHADER, "../Resources/shaders/Defaults/RayTracing/basicFragment.glsl"},
		...
		std::map<GLenum, const char*> CircleShaderList =
		{
			{GL_VERTEX_SHADER,  "../Resources/shaders/Defaults/RayTracing/circleVertex.glsl"},
			{GL_FRAGMENT_SHADER, "../Resources/shaders/Defaults/RayTracing/circleFragment.glsl"}
		};
